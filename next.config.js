    ...
    return [
      {
        ...
        headers: [
          ...
          // HSTS : force HTTPS 2 ans + sous-domaines + éligibilité preload.
          // Sans risque (site 100% HTTPS sur Vercel). Cf. #396.
          {
            key: "Strict-Transport-Security",
            value: "max-age=63072000; includeSubDomains; preload",
          },
          // Permissions-Policy : verrouille les API non utilisées. On garde
          // geolocation=(self) (carte « autour de moi »). Cf. #396.
          {
            key: "Permissions-Policy",
            value: "geolocation=(self), camera=(), microphone=(), payment=(), usb=()",
          },
          // CSP en REPORT-ONLY d'abord : ne bloque rien, ne fait que rapporter
          // les violations → on observe avant de passer en enforcing (#396).
          // Sources : self, tiles CartoCDN, Supabase (REST/Storage/Realtime),
          // PostHog, Sentry, images Wikimedia. 'unsafe-inline' toléré (JSON-LD
          // schema.org + styles inline MapLibre/Tailwind).
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "img-src 'self' data: blob: https://*.basemaps.cartocdn.com https://*.supabase.co https://upload.wikimedia.org https://*.wikimedia.org https://commons.wikimedia.org",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.posthog.com https://*.sentry.io https://*.ingest.sentry.io https://*.basemaps.cartocdn.com",
